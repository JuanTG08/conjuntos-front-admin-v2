...
export async function getServerSideProps(context) {
  try {
    ...
    const getData =
      await LogsBookIncidentsCtrl.apiSSRGetListAllLogsBookIncidents(getCookies);
    // if (getData.error || getData.statusCode != 200) throw new Error("No fue posible obtener los datos");
    return {
      props: {
