...
const CorrespondenceList = ({ dataUser }) => {
  ...
  const changeCheckCorrespondence = async (idCorrespondence) => {
    try {
      ...
      if (setChangeCheck.error || setChangeCheck.statusCode !== 200)
        return messageApi.warning(setChangeCheck.message);
                  ...
                  <Card className="h-full" radius="none">
                    ...
                    <CardFooter>
                      <div className="flex gap-1">
                        ...
                        {/*}
                        <Chip color="default" className="ml-2">
                          {DateUtils.formatDate(item.date_start)}
                        </Chip>
                        */}
                      </div>
                    </CardFooter>
  ...
  return (
    <>
      <HeaderPage title={"Listado de Correspondencia"} />
      {contextHolder}
